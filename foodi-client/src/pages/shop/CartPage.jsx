      ...
      {/* row 1 */}
       {
          cart.map((item, index) => (
            ...
            <input type="number" value={item.quantity} onChange={() => console.log(item.quantit)} className='w-10 mx-2 text-center overflow-hidden appearance-none' />
